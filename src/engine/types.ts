...
_l2i[65] = 0; _l2i[66] = 1; _l2i[67] = 2; _l2i[68] = 3; _l2i[69] = 4;
...
export function flattenRule(r: ValidationRule): FlatRule {
	return {
		...
		otherQuestionIndex:
			"otherQuestionIndex" in r ? r.otherQuestionIndex : -1,
	};
}
...
const GLOBAL_RULE_IDS = new Set<RuleTypeId>([
	RT_COUNT_ANSWER, RT_COUNT_VOWEL, RT_COUNT_CONSONANT,
	RT_LEAST_COMMON, RT_MOST_COMMON, RT_MOST_COMMON_COUNT,
	RT_UNIQUE, RT_EQUAL_COUNT, RT_TRUE_STMT,
	RT_ONLY_SAME, RT_CONSEC_IDENT, RT_ONLY_ODD,
	RT_FIRST_WITH, RT_LAST_WITH, RT_SAME_AS,
]);
...
export function flattenPuzzle(puzzle: Puzzle): FlatPuzzle {
	...
	return {
		rules,
		optionLabels: puzzle.questions.map((q) =>
